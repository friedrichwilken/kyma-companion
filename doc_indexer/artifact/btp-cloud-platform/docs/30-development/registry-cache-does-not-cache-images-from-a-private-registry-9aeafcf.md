...
3.  If you see this pattern repeating, verify that the credentials in the Secret referenced by `spec.secretReferenceName` are correct and that the Secret is up to date.

    To learn how to update the credentials, see [Rotating Credentials](rotating-credentials-d5848fd.md).
